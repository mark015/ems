...
function searchLead(){
    ...
    $brgyId = $_POST['brgyId'];
    $coorId = $_POST['coorId'];
    $searchLeaderVal = $_POST['searchLeaderVal'];
    ...
    inner join brgy on election_2023.brgy=brgy.id
    inner join position on election_2023.pos=position.id
     where election_2023.pos='2' && coordinator_id = '$coorId'  && election_2023.name like '%$searchLeaderVal%' && election_2023.brgy='$brgyId'
     ";
    $result = mysqli_query($conn, $sql);
    if ($result->num_rows > 0) {
...
function searchMem(){
    ...
    $brgyId = $_POST['brgyId'];
    $leadId = $_POST['leadId'];
    $searchMemberVal = $_POST['searchMemberVal'];
    ...
    inner join brgy on election_2023.brgy=brgy.id
    inner join position on election_2023.pos=position.id
     where election_2023.pos='3' && leader_id = '$leadId'  && election_2023.name like '%$searchMemberVal%' && election_2023.brgy='$brgyId'
     ";
    $result = mysqli_query($conn, $sql);
    if ($result->num_rows > 0) {
